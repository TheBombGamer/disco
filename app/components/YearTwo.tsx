...
const YearTwo = () => {
  ...
  return (
    <div>
      <h6 className="font-bold">All 200lv Students</h6>
      ...
      {students.map((student) =>
        student.level == "200" && student.role == "student" ? (
          <>
            <div>
              <div className="flex w-full bg-slate-900">
                <div className="w-full flex -t-lg p-2 gap-2">
                  ...
                  <h6 className="flex-1 md:text-sm text-[10px] text-gray-300 font-semibold">
                    {student.email}
                  </h6>
                  <h6 className="flex-1 md:text-sm text-[10px] text-gray-300 font-semibold">
                    {student.matric}
